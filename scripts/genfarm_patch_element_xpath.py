...
from genfarmer_automation.elementexists_schema import (  # noqa: E402
    ElementExistsSchemaError,
    printable_path,
    resolve_xpath_path,
)
from genfarmer_automation.genfarm_file import GenFarmDocument, GenFarmFileError  # noqa: E402
from genfarmer_automation.structure_paths import set_existing_path  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print("=" * 78)
        return 0
    except (ElementExistsSchemaError, GenFarmFileError, OSError, ValueError, json.JSONDecodeError) as exc:
